...
#' 
#' By default, `checkpoint()` uses https to download packages. The default MRAN snapshot defaults to \url{https://cran.microsoft.com/snapshot/} in R versions 3.2.0 and later, if https support is enabled.
#' 
